...
namespace winrt::HotelManagement::implementation
{
    ...
    struct MainPage : MainPageT<MainPage>
    {
        ...
        Windows::Foundation::IAsyncAction System_BackRequested(Windows::Foundation::IInspectable const& /* sender */, Windows::UI::Core::BackRequestedEventArgs const& args);
        
        Windows::Foundation::IAsyncOperation<bool> TryGoBack();
