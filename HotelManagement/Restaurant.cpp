...
namespace winrt::HotelManagement::implementation
{
    ...
    void Restaurant::Page_Loaded(winrt::Windows::Foundation::IInspectable const& sender, winrt::Windows::UI::Xaml::RoutedEventArgs const& e)
    {
    ...
    winrt::Windows::Foundation::IAsyncAction Restaurant::btnReserve_Click(winrt::Windows::Foundation::IInspectable const& sender, winrt::Windows::UI::Xaml::RoutedEventArgs const& e)
    {
